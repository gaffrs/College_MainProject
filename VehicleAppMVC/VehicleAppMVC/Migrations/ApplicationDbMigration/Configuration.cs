namespace VehicleAppMVC.Migrations.ApplicationDbMigration
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<VehicleAppMVC.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(VehicleAppMVC.Models.ApplicationDbContext context)
        {
            ...
            new ApplicationUser { UserName = "john@gmail.com", Email = "john@gmail.com", PhoneNumber = "0871234568", PasswordHash = hasher.HashPassword("$Password1") },
            new ApplicationUser { UserName = "paul@gmail.com", Email = "paul@gmail.com", PhoneNumber = "0871234569", PasswordHash = hasher.HashPassword("$Password1") }
            );
        }
    }
}
