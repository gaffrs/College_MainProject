        ...
        protected override void Seed(VehicleWebApp.Models.VehicleWebAppContext context)
        {
            ...
            //                       {
                        ...
                        context.Costs.AddOrUpdate(c => c.CostID,
                            new Cost { VehicleID = 1, CostDate = new DateTime(2018, 1, 01), CostOdometerMileage = 1000, CostTitle = eCostTitle.Insurance, CostRunningCost = 700, CostStartDate = new DateTime(2017, 1, 20), CostEndDate = new DateTime(2018, 1, 20) },
            ...
            context.Costs.AddOrUpdate(c => c.CostID,
                new Cost { VehicleID = 1, CostDate = new DateTime(2099, 1, 01), CostOdometerMileage = 1000, CostTitle = eCostTitle.Insurance, CostRunningCost = 700, CostStartDate = new DateTime(2017, 1, 20), CostEndDate = new DateTime(2018, 1, 20) },
                new Cost { VehicleID = 1, CostDate = new DateTime(2017, 5, 01), CostOdometerMileage = 3000, CostTitle = eCostTitle.Service, CostRunningCost = 399, CostStartDate = new DateTime(2017, 1, 20), CostEndDate = new DateTime(2018, 1, 20) },
                new Cost { VehicleID = 1, CostDate = new DateTime(2017, 6, 01), CostOdometerMileage = 4000, CostTitle = eCostTitle.Tax, CostRunningCost = 250, CostStartDate = new DateTime(2017, 7, 20), CostEndDate = new DateTime(2018, 7, 20) }
